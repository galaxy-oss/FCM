...
class BaseValidator:
    ...
    def __init__(self, dataloader=None, save_dir=None, pbar=None, args=None, _callbacks=None):
        ...
        self.batch_i = None
        self.training = True
        self.speed = {'preprocess': 0.000, 'inference': 0.0, 'loss': 0.0, 'postprocess': 0.0000}
        self.jdict = None
    ...
    def __call__(self, trainer=None, model=None):
        ...
        if self.training:
            ...
            LOGGER.info('Speed: %.1fms preprocess, %.3fms inference, %.1fms loss, %.1fms postprocess per image' %
